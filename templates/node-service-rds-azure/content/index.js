...
const host = process.env.DB_HOST || "my-pocrds-ops00123456-plateng-poc-rds-development.cptsrelsr8pt.us-east-1.rds.amazonaws.com";
const client = new Pool({
  host,
  user: process.env.DB_USER || "postgres",
  password: process.env.DB_PASSWORD || "admin123",
  database: process.env.DB_DATABASE || "sumiso",
